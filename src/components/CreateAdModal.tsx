        ...
        <Dialog.Portal>
          ...
          <Dialog.Content className='fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[600px] shadow-lg shadow-black/25'>
            <Dialog.Title className='text-3xl font-black'>Publique um anúncio</Dialog.Title>
              ...
              <form onSubmit={handleCreateAd} className='mt-8 flex flex-col gap-4 w-full'>
                ...
                <div className='grid grid-cols-2 gap-16 mr-4'>
                ...
                <div className='flex gap-6'>
                  ...
                  <div className='flex flex-col gap-2 flex-1'>
                    ...
                    <div className='grid grid-cols-2 gap-2'>
                      ...
                      <Input name='hoursEnd' id='hoursEnd' type="time" placeholder='Ate' />
                    </div>
                  </div>
                </div>

                <label className='mt-2 flex items-center gap-2 text-sm text'>
                  <Checkbox.Root 
